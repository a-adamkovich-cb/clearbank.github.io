...
A DDI can be set up against real and virtual accounts held with ClearBank. You will receive the Bacs Mandate Created webhook once the DDI is present in our system.
